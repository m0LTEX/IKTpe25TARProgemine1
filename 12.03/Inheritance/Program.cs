...
namespace Inheritance
{
    ...
    //läbi pärimise saame kasutada muutijaid width ja height, mis asuvad Shape classis
    //ning neid ei pea siis difineerima rectangle classis
    class Rectangle : Shape
    {
        public int GetArea()
        {
            //return tagastab info selles meetodis toimunud liigika kohta
            return width * height;
        }
    }
}
