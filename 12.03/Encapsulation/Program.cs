...
namespace Encapsulation
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //miks internal classe ei saa viidata teistes projektis,
            ...
            //ei saa kasutada kuna asub teises classis,
            //aga samas projektis
            //teha Program,cs classi meetod
            //nimega DoSomethingInProgramClass
            //ja kutsuda see esile Program meetodis
            Console.WriteLine("---------------------------------");
            Program program = new Program();
            program.DoSomethingInProgramClass();

            //kutsuda PrivateStudentIdProgramClass esile
            Console.WriteLine("---PrivateStudentIdProgramClass---");
            Program pp = new Program();
            Console.WriteLine(pp.PrivateProtectedIdProgramClass =
                "PrivateProtectedIdProgramClass");

            //soovime kasutada PrivateProtectedStudent classis olevate 
            ...
            //$ - string format e saan kasutada stringivälised muutujaid
        ...
        private protected string PrivateProtectedIdProgramClass =
                "PrivateProtectedIdProgramClass";
    }
}
