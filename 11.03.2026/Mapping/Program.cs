...
namespace Mapping
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //protsess, kus muudetakse andmed ühest formaadist, strukuurist või
            //süsteemist teiseks
            ...
            car.Name = "Audi";
            car.Title = "CarTitle";
            car.Description = "Slow";

            CarsDto dto3 = new CarsDto();

            dto3.Id = car.Id;
            dto3.Name = car.Name;
            dto3.Title = car.Title;
            dto3.Description = car.Description;


            Console.WriteLine(dto3.Id + " " + dto3.Name + " " + dto3.Title + " " + dto3.Description);
        ...
        //pead kaks klassi tegema nimega Cars ja CarsDto
    }

    //Program.cs on tegemist failiga, kus on Program class ja
    //nüüd oleme lisanud juurde Employee classi
    //kindlasti tuleb jälgida, et class ei oleks classi sees
    ...
    //miks pannakse classi ette nimetuse taha dto?
